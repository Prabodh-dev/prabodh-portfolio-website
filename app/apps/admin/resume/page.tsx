    ...
    <div className="min-h-screen admin-bg">
      ...
      <main className="max-w-4xl mx-auto p-6">
        <div className="neon-box bg-retro-darker/50 p-8 space-y-6">
            ...
            {resume?.fileName ? (
              <div className="border-2 border-retro-cyan/30 p-6 bg-retro-gray">
                <p className="text-retro-cyan mb-2 font-mono">
                  <strong className="text-retro-purple">FILE:</strong>{" "}
                  {resume.fileName}
                </p>
                <p className="text-retro-cyan mb-4 font-mono">
                  <strong className="text-retro-purple">UPLOADED:</strong>{" "}
                  {resume.uploadDate
                    ? new Date(resume.uploadDate).toLocaleString()
                    : "N/A"}
                </p>
                <a
                  href={resume.url || resume.downloadUrl || "/resume.pdf"}
                  target="_blank"
              ...
              <p className="text-retro-cyan font-mono italic">
                {">"} NO_RESUME_UPLOADED_YET
              </p>
            )}
          </div>
          ...
          {message && (
            <p
              className={`font-mono uppercase ${message.includes("success") ? "text-retro-green" : "text-red-500"}`}
            >
          ...
          {uploading && (
            <p className="text-retro-cyan font-mono uppercase">
              {">"} ⟳ UPLOADING...
            </p>
          )}
        </div>
